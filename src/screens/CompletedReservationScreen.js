...
class CompletedReservationScreen extends Component {
  constructor(props) {
    super(props);
  }
    ...
    return (
      <View style={styles.flex}>
        <SafeAreaView style={styles.flex}>
          <TopNavBar type="titleWithSign" title="Reservation Complete!" />
            ...
            <View style={styles.contentView}>
              ...
              <View
                ...
                <View
                  ...
                  <Label title="$550 x 2 Hours" size={14} />
              ...
              <View style={{width: '100%', position: 'absolute', bottom: 0}}>
                <RoundButton
                  ...
                  arrow="left"
                  style={{marginTop: 20}}
                  onPress={() => this.props.navigation.navigate('TravelHome')}
                />
              </View>
            </View>
          </View>
